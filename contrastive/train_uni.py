...
from utils import *
from model import UnimodalTransformer
...
def main():
    ...
    parser.add_argument('--net', '-n', default='visual', help='Net name')
    ...
    output_dir = 'Uni-{}-mlp{}'.format(args.net, args.config)
    ...
    if args.net == 'acoustic':
        net = UnimodalTransformer(25, 256, project_type=args.project)
    else:
        net = UnimodalTransformer(136, 256, project_type=args.project)
